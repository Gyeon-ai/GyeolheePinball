...
- 수집 목록 검색, 복사, 저장
- SOOP 방송국·플레이 주소 또는 순수 ID에서 방송 ID를 정확히 인식
- 방송·핀볼 반영 방식 변경과 전체 삭제 시 이전 대기 후원을 안전하게 초기화
- 신규 후원은 기존 전체 문자열을 다시 만들지 않고 핀볼 문자열 끝에 즉시 반영
- 신규 후원은 전체 목록 대신 필요한 표시 행만 추가·갱신
