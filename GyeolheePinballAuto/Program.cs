...
namespace GyeolheePinballAuto
{
    internal static class Program
    {
        ...
        private static void WriteCrashLog(Exception ex)
        {
            try
            {
                ...
                string path = Path.Combine(baseDir, "GyeolheePinballAuto-error.log");
    ...
    {
        private const string PinballUrl = "https://gyeon-ai.github.io/GyeolheePinball-Web/";
        private const int DirectPinballUrlLimit = 1800;

        private readonly Color _text = Color.FromArgb(54, 44, 84);
        private readonly Color _muted = Color.FromArgb(105, 91, 137);
        private readonly Color _softMuted = Color.FromArgb(139, 126, 169);
        private readonly Color _purple = Color.FromArgb(157, 105, 223);
        private readonly Color _purpleDark = Color.FromArgb(97, 65, 144);
        private readonly Color _lavender = Color.FromArgb(240, 232, 255);
        private readonly Color _line = Color.FromArgb(213, 197, 235);
        private readonly Color _card = Color.FromArgb(255, 253, 255);
        private readonly Color _soft = Color.FromArgb(249, 245, 255);
        private readonly Color _mint = Color.FromArgb(231, 247, 255);
        private readonly Color _green = Color.FromArgb(51, 180, 151);
        private readonly Color _amber = Color.FromArgb(229, 151, 73);
        private readonly Color _red = Color.FromArgb(218, 83, 117);
        ...
        public MainForm()
        {
            ...
            BackColor = Color.FromArgb(229, 224, 250);
            AutoScaleMode = AutoScaleMode.Dpi;
            DoubleBuffered = true;
            Icon = LoadEmbeddedIcon("GyeolheePinballIcon");
            ...
            RefreshStatus("● 연결 안 됨", _muted, Color.FromArgb(249, 246, 255));
        ...
        private void BuildUi()
        {
            ...
            _surface.TopColor = Color.FromArgb(237, 232, 255);
            _surface.BottomColor = Color.FromArgb(218, 243, 255);
            ...
            _logo.Image = LoadEmbeddedImage("GyeolheePinballLogo");
            _logo.Radius = 12;
            _logo.FillColor = Color.Transparent;
            ...
            _appSubtitle.ForeColor = Color.FromArgb(105, 91, 137);
            _appSubtitle.TextAlign = ContentAlignment.MiddleLeft;
            ...
            _footerLeft.ForeColor = Color.FromArgb(111, 94, 143);
            ...
            _footerRight.ForeColor = Color.FromArgb(99, 75, 133);
            _footerRight.FillColor = Color.FromArgb(238, 229, 255);
            _footerRight.BorderColor = Color.FromArgb(190, 157, 224);
            _footerRight.MarkStartColor = Color.FromArgb(205, 146, 235);
            _footerRight.MarkEndColor = Color.FromArgb(115, 193, 239);
        ...
        private void BuildCollectionCard()
        {
            ...
            _emptyIcon.StartColor = Color.FromArgb(238, 228, 255);
            _emptyIcon.EndColor = Color.FromArgb(225, 244, 255);
        ...
        private void BuildPinballCard()
        {
            ...
            _pinballDesc = PlainLabel(BuildCoinGuideText(), 10.0f, FontStyle.Regular, Color.FromArgb(91, 77, 123));
            ...
            _openPinballButton.FillColor = Color.FromArgb(158, 105, 224);
            _openPinballButton.GradientColor = Color.FromArgb(111, 185, 239);
            _openPinballButton.BorderColor = Color.FromArgb(185, 151, 226);
        ...
        private void LayoutHeader(int x, int y, int width)
        {
            ...
            int titleWidth = Math.Max(120, width - statusWidth - 88);

            _logo.SetBounds(x, y, 68, 68);
            _appTitle.SetBounds(x + 80, y + 6, titleWidth - 16, 34);
            _appSubtitle.SetBounds(x + 82, y + 40, titleWidth - 18, 22);
        ...
        private void RefreshStatus(string text, Color textColor, Color fillColor)
        {
            ...
            _statusPill.BorderColor = Color.FromArgb(218, 203, 239);
        ...
        private void RefreshConnectionButton()
        {
            ...
            if (collecting)
            {
                ...
                _connectButton.FillColor = Color.FromArgb(255, 235, 248);
            ...
            else
            {
                ...
                _connectButton.FillColor = Color.FromArgb(159, 105, 225);
                _connectButton.GradientColor = Color.FromArgb(109, 185, 240);
                _connectButton.BorderColor = Color.FromArgb(187, 151, 227);
        ...
        private void SeedPreviewRows()
        {
            ...
            _entries.Add(new CollectedEntry { Source = GiftSource.AdBalloon, Nickname = "결희", BalloonCount = 1017, CoinCount = 11, PinballName = "결희 종겜핀볼", ReceivedAt = DateTime.Now.ToString("HH:mm:ss") });
        ...
        private void StyleSegment(RoundButton button, bool active)
        {
            ...
            if (active)
            {
                ...
                button.BorderColor = Color.FromArgb(190, 159, 226);
                button.ForeColor = _purpleDark;
            }
            else
            {
                button.FillColor = Color.FromArgb(255, 253, 255);
        ...
        private RoundedPanel Card()
        {
            ...
            panel.BorderColor = Color.FromArgb(211, 194, 234);
            return panel;
        }
        ...
        private PillLabel StepBadge(string text)
        {
            ...
            label.BorderColor = Color.FromArgb(204, 181, 233);
            label.Radius = 11;
            return label;
        }
        ...
        private RoundButton PrimaryButton(string text)
        {
            ...
            button.FillColor = Color.FromArgb(157, 105, 223);
            button.BorderColor = Color.FromArgb(157, 105, 223);
        ...
        private RoundButton GradientButton(string text)
        {
            ...
            button.FillColor = Color.FromArgb(158, 105, 224);
            button.GradientColor = Color.FromArgb(111, 185, 239);
            button.BorderColor = Color.FromArgb(185, 151, 226);
            button.ForeColor = Color.White;
            return button;
        }
    ...
    internal sealed class GiftSourcePopup : RoundedPanel
    {
            ...
            bool collectChallengeGift)
        {
            ...
            Radius = 12;
            FillColor = Color.FromArgb(246, 240, 255);
            BorderColor = Color.FromArgb(97, 65, 144);
            BackColor = Color.Transparent;
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            _leftBackdropColor = Color.FromArgb(229, 224, 250);
        ...
        private GiftSourceOption CreateOption(string text, int x, int y, int width, int height, bool isChecked, Color foreColor, Color accent)
        {
            ...
            option.FillColor = Color.FromArgb(255, 253, 255);
            option.CheckedFillColor = Color.FromArgb(235, 224, 251);
            option.BorderColor = Color.FromArgb(198, 167, 228);
    ...
    internal sealed class GiftSourceOption : Control
    {
        ...
        public GiftSourceOption()
        {
            ...
            CheckedFillColor = Color.FromArgb(239, 231, 255);
            BorderColor = Color.FromArgb(213, 197, 235);
            AccentColor = Color.FromArgb(157, 105, 223);
            SetStyle(
    ...
    internal sealed class EntryRowControl : UserControl
    {
        ...
        private readonly Color _editFill = Color.FromArgb(250, 247, 255);
        private readonly Color _editBorder = Color.FromArgb(219, 201, 240);
        ...
        public EntryRowControl(CollectedEntry entry, int index, Color text, Color muted, Color purple, Color lavender, Color line, Color card)
        {
            ...
            _coinFrame.BorderColor = Color.FromArgb(191, 157, 228);
    ...
    internal sealed class InputRequiredDialog : Form
    {
        ...
        {
            _line = line;
            _surface = Color.FromArgb(250, 247, 255);
    ...
    internal sealed class ClearEntriesDialog : Form
    {
        ...
        {
            _line = line;
            _surface = Color.FromArgb(246, 240, 255);
            ...
            body.AutoSize = false;
            body.BackColor = Color.Transparent;
            body.ForeColor = Color.FromArgb(105, 91, 137);
            body.Font = UiFont.Make(8.9f, FontStyle.Regular);
            body.SetBounds(18, 40, 216, 25);
            Controls.Add(body);

            var cancel = DialogButton("취소", Color.FromArgb(82, 68, 111), Color.White, Color.FromArgb(205, 184, 232));
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (GraphicsPath path = Shape.Rounded(rect, 18))
            using (SolidBrush brush = new SolidBrush(_surface))
            using (Pen pen = new Pen(Color.FromArgb(198, 169, 227)))
            {
                e.Graphics.FillPath(brush, path);
                e.Graphics.DrawPath(pen, path);
            }
    ...
    internal sealed class ToastBanner : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (SolidBrush fill = new SolidBrush(Color.FromArgb(62, 44, 92)))
            using (Pen border = new Pen(Color.FromArgb(188, 148, 226)))
            {
                e.Graphics.FillPath(fill, bodyPath);
                e.Graphics.DrawPath(border, bodyPath);
            }

            using (SolidBrush accent = new SolidBrush(Color.FromArgb(119, 192, 239)))
            {
    ...
    internal sealed class GradientSurface : Panel
    {
        ...
        protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            using (var dot = new SolidBrush(Color.FromArgb(24, 173, 132, 219)))
            {
    ...
    internal sealed class CreditBadge : Control
    {
        ...
        {
            Radius = 10;
            FillColor = Color.FromArgb(238, 229, 255);
            BorderColor = Color.FromArgb(190, 157, 224);
            MarkStartColor = Color.FromArgb(205, 146, 235);
            MarkEndColor = Color.FromArgb(115, 193, 239);
            SetStyle(
                ControlStyles.AllPaintingInWmPaint |
                ControlStyles.OptimizedDoubleBuffer |
                ControlStyles.ResizeRedraw |
    ...
    internal class RoundTextBox : UserControl
    {
        ...
        public RoundTextBox()
        {
            Placeholder = "";
            _suffixText = "";
            FillColor = Color.FromArgb(250, 247, 255);
            BorderColor = Color.FromArgb(219, 201, 240);
            FocusBorderColor = Color.FromArgb(157, 105, 223);
            SuffixColor = Color.FromArgb(105, 91, 137);
            Radius = 10;
            BackColor = Color.Transparent;
            SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.OptimizedDoubleBuffer | ControlStyles.ResizeRedraw | ControlStyles.UserPaint, true);
