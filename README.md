...
- 넓은 창에서는 핀볼 내용 입력칸이 닉네임·후원 정보 앞까지 확장되는 유동형 행 배치
...
| File | Version | SHA256 |
|---|---|---|
| `결희 종겜핀볼.exe` | `1.0.0.0` | `C222D5A995F1A6247F0133E5FD1DBCC09E4D203A4676818511A8B363ADD48560` |
| `결희 종겜핀볼(자동).exe` | `1.0.0.0` | `A8753BDF34E204C1959F99459468CCFF2DEE38512F41915E3525ACB054B91021` |
